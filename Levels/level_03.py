...
class Level3:
    ...
    def __init__(self, canvas, settings):
        ...
        self.bottom_top_y = settings.frm_margin + 1
        ...
        self.hook_id = canvas.create_polygon(self.left_bound_x + 200, self.bottom_bound_y - 20, 
                                        self.left_bound_x + 200, self.bottom_top_y, 
                                        self.left_bound_x + 200 + 20, self.bottom_top_y, 
                                        self.left_bound_x + 200 + 20, self.bottom_bound_y - 20, 
                                        self.left_bound_x + 200, self.bottom_bound_y - 20, 
                                        fill=settings.frm_background_field)
        
        self.fake_id = canvas.create_polygon(self.left_bound_x + 200, self.bottom_bound_y, 
                                        self.left_bound_x + 200, self.bottom_bound_y - 20, 
                                        self.left_bound_x + 200 + 20, self.bottom_bound_y - 20, 
        ...
        hook1 = SimpleHook(canvas.bbox(self.hook_id))
        self.hooks = [hook1]
